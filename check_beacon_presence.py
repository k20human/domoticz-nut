...
URL_DOMOTICZ = 'http://127.0.0.1:8080/json.htm?type=command&param=updateuservariable&vname=PARAM_NAME&vtype=2&vvalue=PARAM_CMD'
DOMOTICZ_USER=''
DOMOTICZ_PASS=''
...
TAG_DATA = [
            ["Nut_Kevin","e1:89:ab:5d:94:44",60,0,7,SWITCH_MODE],
            ["Nut_Katia","d7:2b:34:8e:03:34",60,0,8,SWITCH_MODE],
            ["Nut_Marvel","ef:5a:e3:0f:38:cd",60,0,12,SWITCH_MODE]
           ]
